...
fn test_sample_log_parsing() {
    ...
    assert!(warnings[5].message == "/Users/eyeplum/Projects/fallout/samples/BuildWarningSampler/BuildWarningSampler/AppDelegate.swift:23:13: warning: initialization of immutable value 'unusedVariable' was never used; consider replacing with assignment to '_' or removing it");
    assert!(warnings[5].hint.is_some());
